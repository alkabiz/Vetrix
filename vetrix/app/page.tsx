...
export default function DashboardPage() {
  ...
  const getWelcomeMessage = () => {
    if (!user) return "Welcome to VetCare Pro"
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                {user?.role === "admin"
                  ? "Manage your veterinary clinic with full administrative access"
                  : user?.role === "vet"
          ...
          {user?.role === "admin" && (
            <Card className="bg-gradient-to-r from-blue-50 to-indigo-50 border-blue-200">
              <CardHeader>
                <CardTitle className="text-blue-900">Administrator Dashboard</CardTitle>
                <CardDescription className="text-blue-700">
                  You have full access to all system features including user management and system settings.
                </CardDescription>
              </CardHeader>
            </Card>
          )}
          ...
          {user?.role === "assistant" && (
            <Card className="bg-gradient-to-r from-green-50 to-emerald-50 border-green-200">
              <CardHeader>
                <CardTitle className="text-green-900">Assistant Dashboard</CardTitle>
                <CardDescription className="text-green-700">
                  You can manage appointments, owners, pets, and invoices. Medical records are view-only.
                </CardDescription>
              </CardHeader>
            </Card>
          )}
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start gap-4 p-3 rounded-lg bg-green-50 border border-green-200">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <p className="font-medium text-sm">Buddy - Annual checkup completed</p>
                ...
                <div className="flex items-start gap-4 p-3 rounded-lg bg-blue-50 border border-blue-200">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <p className="font-medium text-sm">New appointment scheduled for Luna</p>
                ...
                <div className="flex items-start gap-4 p-3 rounded-lg bg-orange-50 border border-orange-200">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      <p className="font-medium text-sm">Invoice generated for Max's visit</p>
                      <Badge variant="outline" className="text-xs">
                        $125
                      </Badge>
                    </div>
