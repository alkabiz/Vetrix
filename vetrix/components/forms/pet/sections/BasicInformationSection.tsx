      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <FormSelect
            ...
            onChange={(value) => onFieldChange("ownerId", value === "" ? "" : Number(value))}
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <FormSelect
            ...
            onChange={(value) => onFieldChange("breedId", value === "" ? "" : Number(value))}
          ...
          <FormSelect
            ...
            onChange={(value) => onFieldChange("sexId", value === "" ? "" : Number(value))}
            options={sexes.map(s => ({
              value: String(s.id),
              label: s.name
            }))}
        ...
        <div className="grid grid-cols-2 gap-4">
          <FormSelect
            ...
            onChange={(value) => onFieldChange("primaryColorId", value === "" ? "" : Number(value))}
          ...
          <FormSelect
            ...
            onChange={(value) => onFieldChange("secondaryColorId", value === "" ? "" : Number(value))}
            options={colors.map(c => ({
              value: String(c.id),
              label: c.name
            }))}
